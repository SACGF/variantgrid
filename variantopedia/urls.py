...
urlpatterns = [
    ...
    path('server_status', views_server_status.server_status, name='server_status'),
    path('server_status_activity/detail/<int:days_ago>', views_server_status.server_status_activity,
         name='server_status_activity_detail'),
    path('server_status_settings/detail', views_server_status.server_status_settings, name='server_status_settings_detail'),
    path('health_check_details', views_server_status.health_check_details, name='health_check_details'),
    path('database_statistics/detail', views_server_status.database_statistics, name='database_statistics_detail'),
    # Tagging
    path('variant_tags/', views.variant_tags, name='variant_tags'),
    path('variant_tags/stats/', views_tag_stats.tag_stats, name='tag_stats'),
    path('variant_tags/stats/headline', views_tag_stats.tag_stats_headline, name='tag_stats_headline'),
    path('variant_tags/stats/over_time', views_tag_stats.tag_stats_over_time, name='tag_stats_over_time'),
    path('variant_tags/stats/user', views_tag_stats.tag_stats_for_user, name='tag_stats_for_user'),
    path('variant_tags/stats/user/<int:user_id>', views_tag_stats.tag_stats_for_user,
         name='tag_stats_for_other_user'),
    path('variant_tags/stats/by_lab', views_tag_stats.tag_stats_by_lab, name='tag_stats_by_lab'),
    path('variant_tags/stats/genes', views_tag_stats.tag_stats_genes, name='tag_stats_genes'),
    path('variant_tags/stats/co_occurrence', views_tag_stats.tag_stats_co_occurrence, name='tag_stats_co_occurrence'),
    path('variant_tags/stats/re_tagged', views_tag_stats.tag_stats_re_tagged, name='tag_stats_re_tagged'),
    path('variant_tags/stats/tag_genes_over_time', views_tag_stats.tag_stats_tag_genes_over_time,
         name='tag_stats_tag_genes_over_time'),
