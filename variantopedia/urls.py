...
urlpatterns = [
    ...
    path('variant_tags/stats/<genome_build_name>', views_tag_stats.tag_stats, name='genome_build_tag_stats'),
    path('variant_tags/stats/<genome_build_name>/headline', views_tag_stats.tag_stats_headline,
         name='tag_stats_headline'),
    path('variant_tags/stats/<genome_build_name>/over_time', views_tag_stats.tag_stats_over_time,
         name='tag_stats_over_time'),
    path('variant_tags/stats/<genome_build_name>/user', views_tag_stats.tag_stats_for_user,
         name='tag_stats_for_user'),
    path('variant_tags/stats/<genome_build_name>/user/<int:user_id>', views_tag_stats.tag_stats_for_user,
         name='tag_stats_for_other_user'),
    path('variant_tags/stats/<genome_build_name>/by_lab', views_tag_stats.tag_stats_by_lab,
         name='tag_stats_by_lab'),
    path('variant_tags/stats/<genome_build_name>/genes', views_tag_stats.tag_stats_genes, name='tag_stats_genes'),
    path('variant_tags/stats/<genome_build_name>/co_occurrence', views_tag_stats.tag_stats_co_occurrence,
         name='tag_stats_co_occurrence'),
    path('variant_tags/stats/<genome_build_name>/re_tagged', views_tag_stats.tag_stats_re_tagged,
         name='tag_stats_re_tagged'),
    path('variant_tags/stats/<genome_build_name>/tag_genes_over_time',
         views_tag_stats.tag_stats_tag_genes_over_time, name='tag_stats_tag_genes_over_time'),
