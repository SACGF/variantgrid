...
def view_allele(request, allele_id: int):
    ...
    overlaps = sorted(overlaps, key=lambda overlap: (overlap.testing_contexts_objs[0], overlap.value_type))
    ...
    cross_overlaps = sorted(cross_overlaps, key=lambda overlap: (overlap.testing_contexts_objs[0], overlap.value_type))
