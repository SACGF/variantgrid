...
VEP_COLUMNS: tuple[VEPColumnDef, ...] = (
    ...
    VEPColumnDef(
        source_field='ProtVar_stability',
        variant_grid_columns=('protvar_stability',),
        category=ColumnAnnotationCategory.PATHOGENICITY_PREDICTIONS,
        vep_plugin=VEPPlugin.PROTVAR,
        pipeline_types=STANDARD,
        min_columns_version=5,
    ),
    VEPColumnDef(
        source_field='ProtVar_pocket',
        variant_grid_columns=('protvar_pocket',),
        category=ColumnAnnotationCategory.PROTEIN_DOMAINS,
        vep_plugin=VEPPlugin.PROTVAR,
        pipeline_types=STANDARD,
        min_columns_version=5,
    ...
    VEPColumnDef(
        source_field='ProtVar_int',
        variant_grid_columns=('protvar_int',),
        category=ColumnAnnotationCategory.PROTEIN_DOMAINS,
        vep_plugin=VEPPlugin.PROTVAR,
        pipeline_types=STANDARD,
        min_columns_version=5,
    ...
    # ---------- Open Targets (GRCh38, columns_version >= 5) -----------------
    VEPColumnDef(
        source_field='OpenTargets_gwasLocusToGeneScore',
        variant_grid_columns=('open_targets_gwas_l2g_score',),
    ...
    VEPColumnDef(
        source_field='OpenTargets_gwasDiseases',
        variant_grid_columns=('open_targets_gwas_diseases',),
        category=ColumnAnnotationCategory.PHENOTYPE,
        vep_plugin=VEPPlugin.OPEN_TARGETS,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    VEPColumnDef(
        source_field='OpenTargets_studyType',
        variant_grid_columns=('open_targets_study_type',),
        category=ColumnAnnotationCategory.GENE_ANNOTATIONS,
        vep_plugin=VEPPlugin.OPEN_TARGETS,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    VEPColumnDef(
        source_field='OpenTargets_studyId',
        variant_grid_columns=('open_targets_study_id',),
        category=ColumnAnnotationCategory.EXTERNAL_ID,
        vep_plugin=VEPPlugin.OPEN_TARGETS,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    VEPColumnDef(
        source_field='OpenTargets_qtlGeneId',
        variant_grid_columns=('open_targets_qtl_gene_id',),
        category=ColumnAnnotationCategory.GENE_ANNOTATIONS,
        vep_plugin=VEPPlugin.OPEN_TARGETS,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    VEPColumnDef(
        source_field='OpenTargets_qtlBiosampleName',
        variant_grid_columns=('open_targets_qtl_biosample',),
        category=ColumnAnnotationCategory.GENE_ANNOTATIONS,
        vep_plugin=VEPPlugin.OPEN_TARGETS,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    # ---------- EVE / popEVE (GRCh38, VEP >= 116, columns_version >= 5) -----
    VEPColumnDef(
        source_field='EVE_SCORE',
        variant_grid_columns=('eve_score',),
        category=ColumnAnnotationCategory.PATHOGENICITY_PREDICTIONS,
        vep_plugin=VEPPlugin.EVE,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
        min_columns_version=5,
        min_vep_version=116,
    ...
    VEPColumnDef(
        source_field='EVE_CLASS',
        variant_grid_columns=('eve_class',),
        category=ColumnAnnotationCategory.PATHOGENICITY_PREDICTIONS,
        vep_plugin=VEPPlugin.EVE,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    VEPColumnDef(
        source_field='popEVE_SCORE',
        variant_grid_columns=('popeve_score',),
        category=ColumnAnnotationCategory.PATHOGENICITY_PREDICTIONS,
        vep_plugin=VEPPlugin.EVE,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
    ...
    # ---------- PromoterAI (GRCh38, VEP >= 116, columns_version >= 5) -------
    VEPColumnDef(
        source_field='PromoterAI_score',
        variant_grid_columns=('promoter_ai_score',),
        category=ColumnAnnotationCategory.PATHOGENICITY_PREDICTIONS,
        vep_plugin=VEPPlugin.PROMOTER_AI,
        genome_builds=GRCH38,
        pipeline_types=STANDARD,
        min_columns_version=5,
        min_vep_version=116,
    ...
    VEPColumnDef(
        source_field='PromoterAI_tss_pos',
        variant_grid_columns=('promoter_ai_tss_pos',),
...
_VEP_PLUGIN_SETTING_KEYS: dict[VEPPlugin, tuple[str, ...]] = {
    ...
    VEPPlugin.PROTVAR: ("protvar",),
    VEPPlugin.OPEN_TARGETS: ("open_targets",),
    VEPPlugin.EVE: ("eve", "popeve"),
    VEPPlugin.PROMOTER_AI: ("promoter_ai",),
    VEPPlugin.GRANTHAM: (),
    VEPPlugin.LOFTOOL: (),
    VEPPlugin.NMD: (),
