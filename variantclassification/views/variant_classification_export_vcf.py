...
class ExportFormatterVCF(ExportFormatter):
    ...
    def generate_value_for_key(self, ekey: EvidenceKey, record: VariantClassificationModification):
    ...
    def row(self, group: AlleleGroup) -> str:
        ...
        for record in vcms:
            lab_names.append(self.vcf_safe(record.variant_classification.lab.name))
            ...
            discordances.append('1' if self.is_discordant(record.variant_classification) else '0')
