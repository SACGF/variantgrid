...
from variantclassification.views.variant_classification_export_flags import ExportFormatterFlags
...
def dashboard(request: HttpRequest) -> Response:
    ...
    return render(request, 'variantclassification/variant_classification_dashboard.html', context)
