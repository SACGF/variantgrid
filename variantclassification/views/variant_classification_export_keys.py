...
from variantclassification.models import VariantClassificationModification, EvidenceKey, VCBlobDict, EvidenceKeyMap
from variantclassification.views.variant_classification_export_utils import ExportFormatter, AlleleGroup, \
    BaseExportFormatter
...
class ExportFormatterKeys(BaseExportFormatter):
    ...
    def count_classification(self, classification: VariantClassificationModification):
