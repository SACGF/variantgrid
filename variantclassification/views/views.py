...
from variantclassification.forms import EvidenceKeyForm
from variantclassification.models import VariantClassificationAttachment, VariantClassification, \
...
from variantclassification.variant_classification_changes import VariantClassificationChanges
...
def activity(request, latest_timestamp: Optional[str] = None):
    ...
    return render(request, 'variantclassification/activity.html', context)
...
def classifications(request):
    ...
    return render(request, 'variantclassification/classifications.html', context)
...
def view_variant_classification(request, record_id):
    ...
    return render(request, 'variantclassification/variant_classification.html', context)
...
def view_classification_diff(request):
    ...
    return render(request, 'variantclassification/variant_classification_diff.html', context)
...
def variant_classification_import_tool(request: HttpRequest) -> Response:
    ...
    return render(request, 'variantclassification/variant_classification_import_tool.html', context)
...
def create_classification_for_variant(request, variant_id, transcript_id=None):
    ...
    context = {'variant': variant,
               ...
               "consensus": consensus}
    return render(request, 'variantclassification/create_classification_for_variant.html', context)
...
def create_classification_from_hgvs(request, genome_build_name, hgvs_string):
    ...
    context = {"genome_build": genome_build,
               ...
               "lab_error": lab_error,
               "initially_require_sample": settings.VARIANT_CLASSIFICATION_WEB_FORM_CREATE_INITIALLY_REQUIRE_SAMPLE}
    return render(request, 'variantclassification/create_classification_from_hgvs.html', context)
...
def evidence_keys(request, external_page=True, max_share_level=None):
    ...
    return render(request, 'variantclassification/evidence_keys.html', context)
...
def classification_graphs(request):
    ...
    return render(request, 'variantclassification/classification_graphs.html', context)
