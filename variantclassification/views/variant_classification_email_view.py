...
from variantclassification.enums import ShareLevel
from variantclassification.enums.discordance_enums import DiscordanceReportResolution
from variantclassification.models import VariantClassification, variant_classification_flag_types, \
...
def summary_email_content(user: User) -> EmailOutput:
    ...
    html = render_to_string('variantclassification/emails/variant_classification_summary_email.html', context).strip()
    text = render_to_string('variantclassification/emails/variant_classification_summary_email.txt', context).strip()
