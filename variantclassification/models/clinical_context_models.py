...
from variantclassification.enums import ShareLevel, SpecialEKeys
from variantclassification.enums.clinical_context_enums import ClinicalContextStatus
...
class ClinicalContext(FlagsMixin, TimeStampedModel):
    ...
    def latest_report(self) -> Optional['DiscordanceReport']:
        from variantclassification.models import DiscordanceReport
