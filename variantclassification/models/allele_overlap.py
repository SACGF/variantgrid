...
from variantclassification.models import VariantClassificationModification
from variantclassification.models.clinical_context_models import ClinicalContext, CS_TO_NUMBER
