...
from variantclassification.autopopulate_evidence_keys.evidence_from_variant import AutopopulateData
from variantclassification.enums import SpecialEKeys, ValidationCode
