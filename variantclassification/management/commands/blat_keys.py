...
$ python3 manage.py makemigrations --empty variantclassification --name "blat_keys"
Migrations for 'variantclassification':
  variantclassification/migrations/0046_blat_keys.py


2. python3 manage.py blat_keys variantclassification/migrations/0046_blat_keys.py
...
def blat_keys(apps, schema_editor):
    EvidenceKey = apps.get_model("variantclassification", "EvidenceKey")
