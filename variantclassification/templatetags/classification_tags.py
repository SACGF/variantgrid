...
from variantclassification.models import BestHGVS
...
from variantclassification.templatetags.js_tags import jsonify
...
@register.inclusion_tag("variantclassification/tags/variant_classification_history.html")
def variant_classification_changes(changes):
    return {
        "changes": changes
    }

@register.inclusion_tag("variantclassification/tags/clinical_significance.html")
...
@register.inclusion_tag("variantclassification/tags/clinical_significance_select.html")
...
@register.inclusion_tag("variantclassification/tags/clinical_context.html")
def clinical_context(cc: ClinicalContext, user: User):
    return {"cc": cc, "link": user.is_superuser}


@register.inclusion_tag("variantclassification/tags/classification_quick.html", takes_context=True)
...
@register.inclusion_tag("variantclassification/tags/variant_classification_table.html", takes_context=True)
...
@register.inclusion_tag("variantclassification/tags/hgvs.html", takes_context=True)
def hgvs(context, hgvs: BestHGVS, show_variant_link: bool = True):
    return {"hgvs": hgvs, "show_variant_link": show_variant_link}


@register.inclusion_tag("variantclassification/tags/variant_classification_row.html", takes_context=True)
...
@register.inclusion_tag("variantclassification/tags/variant_classification.html")
...
@register.inclusion_tag("variantclassification/tags/variant_classification_discordance_row.html")
...
@register.inclusion_tag("variantclassification/tags/variant_card.html", takes_context=True)
