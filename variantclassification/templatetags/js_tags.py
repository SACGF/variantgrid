...
from variantclassification.views.variant_classification_datatables import DatatableConfig
...
@register.inclusion_tag("variantclassification/tags/timestamp.html")
