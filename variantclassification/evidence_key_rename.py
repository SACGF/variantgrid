...
class EvidenceKeyRenamer:
    ...
    def __init__(self, apps, old_key: str, new_key: str):
        self.apps = apps
        self.EvidenceKey = apps.get_model("variantclassification", "EvidenceKey")
    ...
    def _migrate_existing_evidence_key(self):
        VariantClassification = self.apps.get_model("variantclassification", "VariantClassification")
        VariantClassificationModification = self.apps.get_model("variantclassification", "VariantClassificationModification")
...
class EvidenceSelectKeyRenamer:
    ...
    def _migrate_data(self):
        VariantClassification = self.apps.get_model("variantclassification", "VariantClassification")
        VariantClassificationModification = self.apps.get_model("variantclassification",
