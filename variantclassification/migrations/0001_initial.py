...
import variantclassification.models.evidence_mixin
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinical_context', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='variantclassification.clinicalcontext')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clinical_context', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='variantclassification.clinicalcontext')),
                ('flag_collection', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='flags.flagcollection')),
            ...
            bases=(library.django_utils.guardian_permissions_mixin.GuardianPermissionsMixin, variantclassification.models.evidence_mixin.EvidenceMixin, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant_classification_import', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='variantclassification.variantclassificationimport')),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='variantclassification.variantclassificationimport'),
        ),
        migrations.CreateModel(
            name='EvidenceKey',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification_final', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='variantclassification.variantclassificationmodification')),
                ('classification_original', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='variantclassification.variantclassificationmodification')),
                ('clinical_context_final', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='variantclassification.clinicalcontext')),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='variantclassification.discordancereport')),
            ],
            options={
                'get_latest_by': 'modified',
                'abstract': False,
