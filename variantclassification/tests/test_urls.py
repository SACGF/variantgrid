...
from variantclassification.autopopulate_evidence_keys.autopopulate_evidence_keys import \
    create_variant_classification_for_sample_and_variant_objects
...
class Test(URLTestCase):
    ...
    def setUpClass(cls):
        ...
        variant_classification = create_variant_classification_for_sample_and_variant_objects(cls.user_owner,
                                                                                              sample,
                                                                                              variant,
                                                                                              grch37,
        ...
        variant_classification.patch_value({"clinical_significance": "VUS"}, user=cls.user_owner, save=True)
        variant_classification.publish_latest(cls.user_owner)

        record_kwargs = {"record_id": variant_classification.pk}
        #  = {"report_id": None}
        cls.PRIVATE_OBJECT_URL_NAMES_AND_KWARGS = [
            # ('variant_classification_diff', {"GET_PARAMS": {"history": variant_classification.pk}}, 200),
            # ('variant_classification_diff', {"GET_PARAMS": {"record_ids": f"[{variant_classification.pk}]"}}, 200),
            # ('variant_classification_clinvar_xml', record_kwargs, 200),
            # ('variant_classification_csv', record_kwargs, 200),
            # ('view_template_report', record_kwargs, 200),
            ('variant_classification_history', record_kwargs, 200),
            ('view_variant_classification', record_kwargs, 200),
    ...
    def testAdminUrls(self):
        ADMIN_URL_NAMES_AND_KWARGS = [
            ("activity", {}, 200),
            ("variant_classification_dashboard", {}, 200),
            ('variant_classification_import_tool', {}, 200),
            ('hgvs_issues', {}, 200),
    ...
    def testUrls(self):
        URL_NAMES_AND_KWARGS = [
            ("classifications", {}, 200),
            ("export_variant_classifications_grid", {}, 200),
            ("export_variant_classifications_grid_redcap", {}, 200),
            ("redcap_data_dictionary", {}, 200),
            ("evidence_keys", {}, 200),
            ('variant_classification_export', {}, 200),
            ("classification_graphs", {}, 200),
            ("summary_email_html", {}, 200),
            ("summary_email_text", {}, 200),
            ("overlaps", {}, 200),
            ("evidence_keys_api", {}, 200),
            ("variant_classification_export_api", {}, 200),
        ]
...
# ('api/classifications/auto_populate', AutopopulateView.as_view(), name='variant_classification_auto_populate_api'),
# ('api/classifications/record/', VariantClassificationView.as_view(), name='variant_classification_api'),
# ('api/classifications/record/<record_id>', VariantClassificationView.as_view(), name='variant_classification_with_record_api'),
# ('api/classifications/datatables/', VariantClassificationModificationDatatableView.as_view(), name='variant_classification_datatables')
