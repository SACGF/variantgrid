...
def new_columns(apps, schema_editor):
    ...
    MODIFY_COLUMNS = {
        ...
        "rvis_percentile": {"variant_column": "variantannotation__gene__geneannotation__oe_ratio_percentile"},
    ...
    NEW_VARIANT_GRID_COLUMNS = [
        ...
        {'grid_column_name': 'gnomad_oe_lof',
         'variant_column': 'variantannotation__gene__geneannotation__oe_lof',
         'annotation_level': 'G',
         'width': None,
         'label': 'gnomAD OE LOF',
