...
urlpatterns = [
    ...
    path('view_cohort_details_tab/<int:cohort_id>', views_cohort.view_cohort_details_tab, name='view_cohort_details_tab'),
    ...
    path('cohort/sort/<int:cohort_id>', views_cohort.cohort_sort, name='cohort_sort'),
