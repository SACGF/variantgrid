...
urlpatterns = [
    ...
    path('settings/tags/requires_classification/<tag_id>', views_tag.tag_set_requires_classification, name='tag_set_requires_classification'),
    path('settings/tags/collection/datatable', DatabaseTableView.as_view(column_class=TagConfigCollectionColumns),
         name='tag_config_collections_datatable'),
    path('settings/tags/collection/view/<int:tag_config_collection_id>', views_tag.view_tag_config_collection,
         name='view_tag_config_collection'),
    path('settings/tags/collection/clone/<int:tag_config_collection_id>', views_json.clone_tag_config_collection,
         name='clone_tag_config_collection'),
    path('settings/tags/collection/set_tag_color/<int:tag_config_collection_id>', views_tag.set_tag_color, name='set_tag_color'),
