...
urlpatterns = [
    ...
    path('api/gene/detail/<gene_id>', views_rest.GeneDetailView.as_view(), name='api_gene_detail'),
    path('api/gene_symbol/<gene_symbol>', views_rest.GeneSymbolDetailView.as_view(), name='api_gene_symbol_detail'),
