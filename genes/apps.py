...
class GenesConfig(AppConfig):
    ...
    def ready(self):
        ...
        from genes.signals import hgnc_post_save_handler, panel_app_england_panels_post_save_handler, \
            ...
            refseq_gene_summary_post_save_handler, rvis_gene_summary_post_save_handler, uniprot_post_save_handler
        ...
        post_save.connect(rvis_gene_summary_post_save_handler, sender=CachedWebResource)
