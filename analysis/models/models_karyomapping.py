...
class KaryotypeBins:
    ...
    def _get_variant_and_genotype_values(trio, q=None):
        ...
        return qs.values_list("id", "locus__contig_id", "locus__contig__name", "locus__position",
    ...
    def get_variant_and_genotypes(trio, q=None):
        ...
        for variant_id, contig_id, chrom, position, ref, alt, svlen, samples_zygosity in values_list:
            proband_gt, father_gt, mother_gt = get_genotypes(samples_zygosity)

            variant_data = (variant_id, contig_id, chrom, position, ref, alt, svlen)
