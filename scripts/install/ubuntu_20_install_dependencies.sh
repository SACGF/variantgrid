...
apt-get update
apt-get install -y git-core python3-dev python3-pip python3-gdal gfortran libopenblas-dev liblapack-dev zlib1g-dev bedtools libbz2-dev liblzma-dev libssl-dev libcurl4-openssl-dev curl
