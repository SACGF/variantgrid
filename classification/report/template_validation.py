...
def _build_fixture_context() -> dict:
    ...
    return {
        ...
        "analysis": {"pk": 1, "str": "fixture analysis", "sequencing_run_name": "FIXTURE_RUN",
                     "pair_id": "FIXTURE_PAIR", "dna_sample_name": "FIXTURE_DNA", "rna_sample_name": "FIXTURE_RNA",
                     "output_datetime": datetime(2026, 1, 1, tzinfo=UTC), "module_version": "fixture",
                     "pipeline_version": "fixture"},
        "measures": {"tmb": {"str": "7.0 mut/Mb (Low)", "value": 7.0, "unit": "mut/Mb",
                             "call": "Low", "threshold": "10", "method": "fixture"},
                     "msi": {"str": "1.0% (Stable)", "value": 1.0, "unit": "%",
