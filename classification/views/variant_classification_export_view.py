...
from classification.views.variant_classification_export_clinvar import ExportFormatterClinvar
from classification.views.variant_classification_export_csv import ExportFormatterCSV
from classification.views.variant_classification_export_json import ExportFormatterJSON
from classification.views.variant_classification_export_keys import ExportFormatterKeys
from classification.views.variant_classification_export_mvl import ExportFormatterMVL
from classification.views.variant_classification_export_mvl_shell import ExportFormatterMVLShell
from classification.views.variant_classification_export_redcap import ExportFormatterRedcap, \
    export_redcap_definition
from classification.views.variant_classification_export_report import ExportFormatterReport
from classification.views.variant_classification_export_utils import ConflictStrategy, \
    VCFEncoding, BaseExportFormatter
from classification.views.variant_classification_export_vcf import ExportFormatterVCF
...
def export_view(request: HttpRequest) -> Response:
    ...
    return render(request, 'classification/variant_classification_export.html', context)
...
def export_view_redirector(request: HttpRequest) -> Response:
    ...
    return render(request, 'classification/variant_classification_export_redirect.html', context)
