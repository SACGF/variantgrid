...
class LabGrouping:
    def __init__(self, lab: Lab, records: List[ClassificationModification]):
        self.lab = lab
...
class ExportFormatterClinvar(ExportFormatter):
    ...
    def row_iterator(self):
        by_lab_qs = self.qs.order_by('classification__lab_id')
        for lab, records in group_by_key(by_lab_qs, attrgetter('classification.lab')):
