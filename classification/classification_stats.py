...
def get_classification_counts_allele(qs: QuerySet[ClassificationModification], field: str, possible_values: Iterable[Any]) -> Dict[Any, int]:
    ...
    qs = qs.order_by('classification__variant_info__allele_info__allele_id', '-created').distinct('classification__variant_info__allele_info__allele_id')
...
def get_grouped_classification_counts(user: User,
    ...
    values_qs = vc_qs.values_list("clinical_significance", field, "classification__variant_info__allele_info__allele")
