# Generated by Django 3.1 on 2020-10-29 03:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('P', 'Pending'), ('A', 'Resolved Auto'), ('S', 'Selected'), ('U', 'Unmatchable')], default='P', max_length=1)),
                ('join_mode', models.CharField(blank=True, choices=[('U', 'Uncertain'), ('C', 'Combination')], default=None, max_length=1, null=True)),
