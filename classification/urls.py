...
from classification.views.conflict_view import conflicts_view, ConflictFeedView, overlaps_view
...
urlpatterns = [
    ...
    path('conflicts/feed/<int:conflict_id>', ConflictFeedView.as_view(), name='conflict_feed'),
