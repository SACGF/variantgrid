...
from classification.views.conflict_view import conflicts_view, ConflictCommentView, overlaps_view
...
urlpatterns = [
    ...
    path('conflicts/comments/<int:conflict_id>', ConflictCommentView.as_view(), name='conflict_comments'),
