...
CELERY_TASK_ROUTES = {
    ...
    'upload.tasks.import_dragen_tso500_combined_variant_output_task.ImportDragenTSO500CombinedVariantOutputTask': WEB_WORKERS,
...
CELERY_IMPORTS = (
    ...
    'upload.tasks.import_splicegirl_vcf_task',
