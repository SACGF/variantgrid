...
REDIS_PORT = 6379
CACHE_VERSION = 24  # increment to flush caches (eg if invalid due to upgrade)
CACHES = {
    'default': {
...
CACHED_WEB_RESOURCE_RVIS = "Residual Variation Intolerance Score"
