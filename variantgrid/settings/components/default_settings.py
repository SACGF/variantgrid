...
REDIS_PORT = 6379
CACHE_VERSION = 46  # increment to flush caches (eg if invalid due to upgrade)
if UNIT_TEST:
...
CLASSIFICATION_GRID_FADE_NON_SHARED = False  # Fade grid rows that haven't been shared, for deployments where sharing is the point
