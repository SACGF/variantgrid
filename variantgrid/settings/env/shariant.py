...
VARIANT_CLASSIFICATION_GRID_SHOW_SAMPLE = False
VARIANT_CLASSIFICATION_FILE_ATTACHMENTS = False
VARIANT_CLASSIFICATION_ID_FILTER = False
VARIANT_CLASSIFICATION_SHOW_SPECIMEN_ID = False
...
# if None lab record ID will be used for records instead of CR_lab_id
VARIANT_CLASSIFICATION_ID_OVERRIDE_PREFIX = 'SHARIANT'
