...
CLASSIFICATION_GRID_FADE_NON_SHARED = True
CLASSIFICATION_GRID_SUMMARY_COUNTS = False  # Shariant turns this on once it chooses to show the counts
...
VARIANT_GENE_LEVEL_ENABLED = False  # No fusions here - Shariant imports classifications, not VCFs
...
CLASSIFICATION_SUPPORTED_TRANSCRIPTS = {"NM", "NR", "ENST", "XR", "NC"}
...
CLASSIFICATION_DOWNLOADABLE_JSON_LITERATURE_CITATIONS = True
