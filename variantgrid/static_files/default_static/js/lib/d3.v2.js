(function() {
  ...
  function d3_svg_diagonalVCFion(d) {
    return [ d.x, d.y ];
  }
  function d3_svg_diagonalRadialVCFion(projection) {
    return function() {
  ...
  d3.svg.diagonal = function() {
    ...
    var source = d3_svg_chordSource, target = d3_svg_chordTarget, projection = d3_svg_diagonalVCFion;
  ...
  d3.svg.diagonal.radial = function() {
    var diagonal = d3.svg.diagonal(), projection = d3_svg_diagonalVCFion, projection_ = diagonal.vcfion;
    diagonal.vcfion = function(x) {
      return arguments.length ? projection_(d3_svg_diagonalRadialVCFion(projection = x)) : projection;
    };
    return diagonal;
  };
